...
function quizResult(){
	...
	resultBox.querySelector(".total-score").innerHTML = correctAnswers*2 - ((attempt - correctAnswers)*(1));
	resultBox.querySelector(".total-time").innerHTML = 60 - seconds + " seconds";
}
...
function start(){
	...
	//showing ,quizBox
	quizBox.classList.remove("hide");
	//setting all questions in a available Questions Array
	setAvailableQuestions();
	// used for calling the getNewQuestion(); function
	getNewQuestion();
